    ...
    return (
        <>
            <Box className={classes.root}>
                <h1 className={classes.title}>{props.product.name}</h1>
                <p className={classes.subTitle}>{props.product.phrase}</p>
                        ...
                        >
                            <Grid container alignItems='center'>
                                <Rating
                                    ...
                                    size='medium'
                                />
                                <p className={classes.rating}>{props.product.avg_rating === 0 || props.product.avg_rating === null ? '-' : props.product.avg_rating.toFixed(1)}</p>
                            </Grid>
                        </Grid>
                    </Box>
                    <Box className={classes.productProfile}>
                ...
                <Divider className={classes.productAndReviewsDivider} />
